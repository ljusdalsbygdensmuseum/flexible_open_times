...
/***/ "./src/components/foh-day-select.tsx"
/*!*******************************************!*\
  !*** ./src/components/foh-day-select.tsx ***!
  \*******************************************/
...
/* harmony export */   DaySelect: () => (/* binding */ DaySelect)
/* harmony export */ });
...
function DaySelect({
  ...
  const [dateParam, setDateParam] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(dates);
  const [multipleState, setMultipleState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [removeState, setRemoveState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [prevDate, setPrevDate] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(new Date());
  ...
  const addDate = newDate => {
    setDateParam(currentDate => {
      begOrEndDate(newDate, [...currentDate, {
        date: new Date(newDate)
      }]);
      input[0].value = JSON.stringify([...currentDate, {
        date: new Date(newDate)
      }]);
      return [...currentDate, {
        date: new Date(newDate)
...
/***/ "./src/components/foh-extra-hours.tsx"
/*!********************************************!*\
  !*** ./src/components/foh-extra-hours.tsx ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FohExtraHours)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
...
function FohExtraHours() {
  //get input and data
  //hours
  const hoursInput = document.querySelector('#foh-extra-hours_hours_field');
  if (!hoursInput) {
  ...
  //date
  const dateInput = document.querySelector('#foh-extra-hours_hours_dates_field');
  const mindateInput = document.querySelector('#foh-extra-hours_hours_min_date_field');
  const maxdateInput = document.querySelector('#foh-extra-hours_hours_max_date_field');
...
/***/ "./src/components/foh-settings-fullweek.tsx"
/*!**************************************************!*\
  !*** ./src/components/foh-settings-fullweek.tsx ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FullWeek: () => (/* binding */ FullWeek)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
...
/* harmony import */ var _foh_settings_times__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./foh-settings-times */ "./src/components/foh-settings-times.tsx");
/* harmony import */ var _utility_fohNames__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utility/fohNames */ "./src/utility/fohNames.ts");
...
function FullWeek({
  ...
  const theWeek = week.map((dayObj, index, array) => {
    ...
    const changeItem = (newTime, open, itemIndex) => {
      setWeekArray(oldWeek => {
        const newWeek = oldWeek.concat([]);
        if (open) {
    ...
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_foh_settings_times__WEBPACK_IMPORTED_MODULE_4__.Times, {
          hours: weekArray[index],
          onRemoveItem: removeItem,
          onChangeItem: changeItem
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelRow, {
          children: week[index].length < 4 && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
            variant: 'secondary',
            onClick: addMoreHours,
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Add Additional hours', 'foh-domain')
          })
        })]
      })
    });
...
/***/ "./src/components/foh-settings-times.tsx"
/*!***********************************************!*\
  !*** ./src/components/foh-settings-times.tsx ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Times({
  ...
  const theTimes = hours.map((timeObj, index) => {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FlexItem, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TimePicker.TimeInput, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Open', 'foh-domain'),
            value: timeObj.open,
            onChange: newTime => {
          ...
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TimePicker.TimeInput, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Close', 'foh-domain'),
            value: timeObj.close,
            onChange: newTime => {
          ...
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
            ...
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Remove', 'foh-domain')
          })
        })]
      })
    });
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_foh_extra_hours__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/foh-extra-hours */ "./src/components/foh-extra-hours.tsx");




_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_1___default()(() => {
  const root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createRoot)(document.getElementById('foh-extra-hours_container'));
  root.render((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_foh_extra_hours__WEBPACK_IMPORTED_MODULE_3__["default"], {})
  }));
});
})();
...
/******/ })()
;
//# sourceMappingURL=metabox_extra.js.map